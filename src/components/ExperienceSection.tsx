...
const journey: RouteStop[] = [
  {
    ...
    description: 'Leading the Group strategic HR transformation agenda: succession planning, HR strategy, performance management, AI deployment, and workforce capability building. Built 10+ in-house AI agents and presented workforce analytics to the NRC and Board.',
  },
  {
    id: '02',
    year: '2023 - 2025',
  ...
  },
  {
    ...
    description: 'Built and led the end-to-end talent function across acquisition, management, learning, and OD, heading a team of 12. Multiple CEO Excellence Awards (2017, 2018) and Emerging Leader Award (2019) for sustained HR innovation and business impact.',
  },
  {
    id: '05',
    year: '2015 - 2017',
    title: 'GROUP HEAD, LEARNING & DEVELOPMENT',
    organization: 'ADITYA BIRLA SUN LIFE INSURANCE, INDIA',
    description: 'Led the enterprise learning and development agenda, building capability frameworks and leadership programmes across the organisation.',
  },
  {
    id: '06',
    year: '2008 - 2015',
    title: 'ZONAL TRAINING & TALENT DEVELOPMENT HEAD, SOUTH',
    organization: 'ADITYA BIRLA SUN LIFE INSURANCE, INDIA',
    description: 'Owned training and talent development across the South zone, scaling frontline and leadership capability through structured development tracks.',
  },
  {
    id: '07',
    year: '2006 - 2008',
    title: 'DISTRIBUTION HR & TRAINING HEAD, TAMIL NADU',
    organization: 'BHARTI AXA, INDIA',
    description: 'Led distribution HR and training for Tamil Nadu, partnering with business to build and develop the field force.',
  },
  {
    id: '08',
    year: '2003 - 2006',
    title: 'TRAINING MANAGER',
    organization: 'MAX NEW YORK LIFE INSURANCE, INDIA',
    description: 'Delivered training and capability building programmes across the business.',
  },
  {
    id: '09',
    year: '2001 - 2003',
    title: 'MANAGER, AIRPORT',
    organization: 'SRILANKAN AIRLINES, INDIA',
    description: 'Managed airport operations, service delivery, and frontline teams.',
  },
  {
    id: '10',
    year: '1998 - 2001',
    title: 'ASSISTANT MANAGER, COMMERCIAL',
    organization: 'JET AIRWAYS, INDIA',
    description: 'Commercial operations across a fast-growing aviation network.',
  },
];
